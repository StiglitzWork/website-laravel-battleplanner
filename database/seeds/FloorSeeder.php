...
class FloorSeeder extends Seeder
{
    ...
    public function run()
    {
      $floorArray = [
        ...
        /*Oregon Second*/ ['name'=> "second", 'src'=> "/media/maps/Clean/Second.jpg", 'floorNum'=>2, 'map_id'=>Map::byName("oregon")->id],
        /*Oregon Roof*/ ['name'=> "roof", 'src'=> "/media/maps/Clean/Roof.jpg", 'floorNum'=>3, 'map_id'=>Map::byName("oregon")->id],
