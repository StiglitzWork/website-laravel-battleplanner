...
class MapSeeder extends Seeder
{
    ...
    public function run()
    {
        $mapArray = [
          ...
          /*Kanal*/ ['name'=>"kanal",'thumbsrc'=> "/media/thumbs/kanal.jpg", 'comp'=>true],
          ...
          /*Hereford*/ ['name'=>"hereford",'thumbsrc'=> "/media/thumbs/hereford.jpg", 'comp'=>false],
          /*Skyscraper*/ ['name'=>"skyscraper",'thumbsrc'=> "/media/thumbs/skyscraper.png", 'comp'=>false],
