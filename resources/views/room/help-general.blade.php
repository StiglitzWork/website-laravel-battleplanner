...
<p>
  Anyone can draw on the map, however it will not be saved the next time the map is loaded, all those changes will be gone unless the room owner specifically saved them. Take that griefers!
</p>
