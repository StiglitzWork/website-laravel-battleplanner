...
@if ($room->Owner == Auth::User())
    <div class="row margin10">
        <div class="col-6">
                <button type="button" name="button" class="btn btn-info sidebar-btn" data-toggle="modal"
                    data-target="#mapModal">Load/New</button>
        </div>
        <div class="col-6">
                <button type="button" name="button" class="btn btn-success sidebar-btn" data-toggle="modal" data-target="#save">Save</button>
        </div>
    </div>
@endif
<div class="row margin10">
